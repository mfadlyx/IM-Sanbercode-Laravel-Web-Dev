...
// Code function di sini
 function greetings($nama){
    echo "halo <b>$nama</b>, Selamat Datang di Sanbercode! <br>";
 }
...
// echo tentukan_nilai(10); //Sangat Kurang
